...
class AppConfig:
    ...
    ANALYZER_LIGHTWEIGHT_MODE = True  # Use lightweight mode by default
    FORCE_CPU_FOR_ANALYSIS_MODELS = True  # Force analysis models to CPU
    DISABLE_DEPTH_ESTIMATION = True  # Disable depth estimation (very memory intensive)
    DISABLE_HEAVY_MODELS = True  # Generally disable heavy models when not critical
